...
import ipdb
#set_trace this is a debugger you turn on when you want to check for bugs
...
#PYTHON
    #true , if condition else default value
#return truthy value of pet         if meets the condition       otherwise       #print this instead
